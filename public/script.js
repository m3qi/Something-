...
function setupMusic() {
    ...
    if (currentSongUrl && currentSongUrl.trim() !== '') {
        ...
        audioPlayer.play().catch(() => {
            playerDiv.innerHTML += `<div style="color:#ffaaaa; font-size:0.8rem; margin-top:5px;">⚠️ اضغط هنا لتشغيل الموسيقى</div>`;
            const warning = playerDiv.lastChild;
            warning.onclick = () => audioPlayer.play();
        });
